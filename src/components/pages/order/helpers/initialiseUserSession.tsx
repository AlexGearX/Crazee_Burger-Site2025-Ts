...
const intialiseMenu = async (username: string, setMenu: React.Dispatch<React.SetStateAction<MenuProduct[]>>) => {
  const menuReceived = await getMenu(username)
  if (menuReceived) setMenu(menuReceived as MenuProduct[])
}
...
export const initialiseUserSession = async (
  username: string,
  setMenu: React.Dispatch<React.SetStateAction<MenuProduct[]>>,
  setBasket: React.Dispatch<React.SetStateAction<BasketProductQuantity[]>>
) => {
